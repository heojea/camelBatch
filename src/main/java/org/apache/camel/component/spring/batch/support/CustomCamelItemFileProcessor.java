 ...
 */
public class CustomCamelItemFileProcessor<I, O> implements ItemProcessor<I, O> {

    private static final Logger LOG = LoggerFactory.getLogger(CustomCamelItemFileProcessor.class);

    private final ProducerTemplate producerTemplate;

    private final String endpointUri;

    public CustomCamelItemFileProcessor(ProducerTemplate producerTemplate, String endpointUri) {
