...
public class CustomStreamCamelItemReader<I> extends ServiceSupport implements ItemReader<I>, InitializingBean {

    private static final Logger LOG = LoggerFactory.getLogger(CustomStreamCamelItemReader.class);
    ...
    public CustomStreamCamelItemReader(ConsumerTemplate consumerTemplate, String endpointUri) {
