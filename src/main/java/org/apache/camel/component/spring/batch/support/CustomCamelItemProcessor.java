 ...
 */
public class CustomCamelItemProcessor<I, O> implements ItemProcessor<I, O> {

    private static final Logger LOG = LoggerFactory.getLogger(CustomCamelItemProcessor.class);

    private final ProducerTemplate producerTemplate;

    private final String endpointUri;

    public CustomCamelItemProcessor(ProducerTemplate producerTemplate, String endpointUri) {
