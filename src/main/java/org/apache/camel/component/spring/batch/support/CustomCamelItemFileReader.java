...
public class CustomCamelItemFileReader<I> extends ServiceSupport implements ItemStreamReader<I>, InitializingBean {

    private static final Logger LOG = LoggerFactory.getLogger(CustomCamelItemFileReader.class);
    ...
    public CustomCamelItemFileReader(ConsumerTemplate consumerTemplate, String endpointUri) {
