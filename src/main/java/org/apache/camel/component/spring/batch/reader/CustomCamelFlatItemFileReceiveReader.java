 ...
 */
package org.apache.camel.component.spring.batch.reader;

import org.apache.camel.CamelContext;
import org.apache.camel.ConsumerTemplate;
import org.apache.camel.component.spring.batch.file.FlatFileItemReader.WarraperFlatFileItemReader;
...
public class CustomCamelFlatItemFileReceiveReader<I> extends WarraperFlatFileItemReader<I>{

    private static final Logger LOG = LoggerFactory.getLogger(CustomCamelFlatItemFileReceiveReader.class);

    private final CamelContext camelContext;
    private final ConsumerTemplate consumerTemplate;
    private final String endpointUri;

    public CustomCamelFlatItemFileReceiveReader(ConsumerTemplate consumerTemplate, String endpointUri ) {
